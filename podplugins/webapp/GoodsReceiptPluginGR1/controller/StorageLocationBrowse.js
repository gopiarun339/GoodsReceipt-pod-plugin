sap.ui.define([
    ...
    let StorageLocationBrowseType = BrowseBase.extend("Arun.ext.viewplugins.GoodsReceiptPluginGR1.controller.StorageLocationBrowse", {
    ...
    return {
        ...
        open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback, oModel) {
            return new StorageLocationBrowseType("storageLocationBrowse", {
                oModel: oModel,
                sFragmentName: "Arun.ext.viewplugins.GoodsReceiptPluginGR1.view.fragment.StorageLocationsBrowse",
